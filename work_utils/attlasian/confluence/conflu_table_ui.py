...
class Scraper:
    ...
    def get_url(self):
        ...
        content_url = f"https://confluence.xxxx.com/confluence/rest/api/content?spaceKey={space}&title={title}&expand=body.storage"
        return content_url
    ...
    def create_ui(self):
        ...
        tk.Label(self.w, text=u'exapmle URL: https://confluence.xxx.com/confluence/display/RPM/xxxx').pack()
        tk.Label(self.w, text=u'with above URL -> Space: RPM, Title: xxxx').pack()
